...
function setcity(provinceid, cityid) {
    ...
    switch (province) {
        ...
        case "Country" :
            ...
            break;
        default:
            var cityOptions = new Array("Select your city/country!", "");
            break;
    }
	
	var cityObject = document.getElementById(cityid);
	cityObject.options.length = 0;
	cityObject.options[0] = new Option("Chọn", "");
	var j = 0;
...
// nguyen ban	var html = "&nbsp;<select name=\"" + cityid + "\" id=\"" + cityid + "\">";
	var html = "&nbsp;<select name=\"quan\" id=\"" + cityid + "\">";
	if(city == "") {
		html = html + "<option value=\"0\">Quận Huyện</option>";
	} else {
